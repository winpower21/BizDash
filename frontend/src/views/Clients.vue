<template>
    <h1>Clients</h1>
    <hr>
    <div class="container parent" v-if="clients.length > 0">
        ...
        <div class="text-center mt-4">
            <a href="/new-client" class="btn btn-primary new-client-button">New Client</a>
        </div>
    </div>
    <div v-else class="alert alert-info" role="alert">
        <p>There are no clients. Create a new one.</p>
        <hr>
        <RouterLink class="btn btn-primary" to="/new-client">New Client</RouterLink>
    </div>
</template>
